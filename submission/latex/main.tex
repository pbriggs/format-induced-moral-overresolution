...
The amended frozen roster contained five models: \path{claude-sonnet-4-6}, \path{deepseek/deepseek-v3.2}, \path{gpt-5.5}, \path{grok-4.3} and \path{qwen/qwen3.7-max}. Each model had 9,500 target calls. API routes and call windows are reported in Table 1a.
