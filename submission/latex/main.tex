...
Item-composition sensitivity preserved the directional endpoint pattern in high-annotation-only analyses and after excluding \texttt{info}-majority or high-\texttt{info} items.
...
The study was preregistered on OSF as a target-scoped computational audit. It used existing SCRUPLES source-community judgments and newly collected LLM API outputs; no new human participants were recruited. The analysis uses the frozen 50k target-scoped exports from \texttt{post\_run/analysis\_exports/50k/}.
...
Derived analysis files and reproducibility records are available through the OSF project (\texttt{https://osf.io/rwhax/overview}), OSF registration home (\texttt{https://osf.io/rwhax/registrations}), GitHub repository (\texttt{https://github.com/pbriggs/format-induced-moral-overresolution}), the post-50k execution/completion archive (\texttt{https://doi.org/10.5281/zenodo.20786461}) and the paper-analysis archive (\texttt{https://doi.org/10.5281/zenodo.20789625}). The corresponding release tags are \texttt{post-50k-completion-v1} and \texttt{paper-analysis-50k-v1}.
...
Analysis and figure-generation code are available at \texttt{https://github.com/pbriggs/format-induced-moral-overresolution} and archived under release tag \texttt{paper-analysis-50k-v1} with DOI \texttt{https://doi.org/10.5281/zenodo.20789625}. The repository includes preprocessing, prompt/schema, parsing/validation, bootstrap-analysis, manuscript-table and figure-rendering code. API credentials and provider-specific secrets are not included.

Local setup and regeneration instructions are provided in \texttt{README.md}, \texttt{.env.example} and \texttt{docs/DATA\_SETUP.md}. Offline regeneration uses completed-run data in an authorized local or reviewer environment and does not make new provider calls. Optional provider-call reruns require the rerunning researcher's own provider credentials and may produce new model outputs rather than exactly reproducing the frozen 50k collection.
...
\textbf{Table 1a | Model roster and collection windows.}

\begin{landscape}
\small
\begin{longtable}{p{0.22\linewidth}p{0.14\linewidth}p{0.14\linewidth}p{0.14\linewidth}p{0.14\linewidth}p{0.14\linewidth}}
 \toprule
Model ID & Provider/route & API route & First call UTC & Last call UTC & Target calls \\
 \midrule
\texttt{claude-sonnet-4-6} & Anthropic & \texttt{https://api.anthropic.com/v1/messages} & 2026-06-16T22:25:08.996871+00:00 & 2026-06-21T15:33:15.162406+00:00 & 9,500 \\
\texttt{deepseek/deepseek-v3.2} & OpenRouter-compatible route & \texttt{https://openrouter.ai/api/v1/chat/completions} & 2026-06-16T22:25:04.892615+00:00 & 2026-06-21T15:33:02.923140+00:00 & 9,500 \\
\texttt{gpt-5.5} & OpenAI & \texttt{https://api.openai.com/v1/responses} & 2026-06-16T22:25:12.406257+00:00 & 2026-06-21T15:33:16.432159+00:00 & 9,500 \\
\texttt{grok-4.3} & xAI & \texttt{https://api.x.ai/v1/responses} & 2026-06-17T17:55:15.846572+00:00 & 2026-06-21T15:32:59.334062+00:00 & 9,500 \\
\texttt{qwen/qwen3.7-max} & OpenRouter-compatible route & \texttt{https://openrouter.ai/api/v1/chat/completions} & 2026-06-16T22:25:15.735026+00:00 & 2026-06-21T15:33:13.991444+00:00 & 9,500 \\
 \bottomrule
\end{longtable}
\normalsize
\end{landscape}
...
\textbf{Table 1b | Target allocation by study component.}

\begin{landscape}
\small
\begin{longtable}{p{0.22\linewidth}p{0.14\linewidth}p{0.14\linewidth}p{0.14\linewidth}}
 \toprule
...
\textbf{Extended Data Fig. 3 | Validity by model and prompt mode.} Primary-valid output rates by model and prompt mode show high validity and limited invalid outputs in the frozen 50k target-scoped analysis.
...
\textbf{Supplementary Table 3 | Annotation and \texttt{info} robustness.} Reports high-annotation-only, \texttt{info}-majority exclusion and high-\texttt{info} exclusion checks.
